...
func TestTypeRegexp(t *testing.T) {
	tests := []struct {
		...
		{"fixed256x20", nil, Type{T: FixedPointTy, Size: 256, FixedFractionSize: 20, stringKind: "fixed256x20"}},
		{"fixed128x80", nil, Type{T: FixedPointTy, Size: 128, FixedFractionSize: 80, stringKind: "fixed128x80"}},
		{"fixed136x1[]", nil, Type{T: SliceTy, Elem: &Type{T: FixedPointTy, Size: 136, FixedFractionSize: 1, stringKind: "fixed136x1"}, stringKind: "fixed136x1[]"}},
		{"fixed144x15[2]", nil, Type{T: ArrayTy, Size: 2, Elem: &Type{T: FixedPointTy, Size: 144, FixedFractionSize: 15, stringKind: "fixed144x15"}, stringKind: "fixed144x15[2]"}},
		{"ufixed256x10", nil, Type{T: UfixedPointTy, Size: 256, FixedFractionSize: 10, stringKind: "ufixed256x10"}},
		{"ufixed128x80", nil, Type{T: UfixedPointTy, Size: 128, FixedFractionSize: 80, stringKind: "ufixed128x80"}},
		{"ufixed136x1[]", nil, Type{T: SliceTy, Elem: &Type{T: UfixedPointTy, Size: 136, FixedFractionSize: 1, stringKind: "ufixed136x1"}, stringKind: "ufixed136x1[]"}},
		{"ufixed144x15[2]", nil, Type{T: ArrayTy, Size: 2, Elem: &Type{T: UfixedPointTy, Size: 144, FixedFractionSize: 15, stringKind: "ufixed144x15"}, stringKind: "ufixed144x15[2]"}},
...
func TestTypeCheck(t *testing.T) {
	for i, test := range []struct {
		...
		{"uint01", nil, big.NewInt(1), "abi: wrong variable size: 01"},
		{"int01", nil, big.NewInt(1), "abi: wrong variable size: 01"},
		{"int0", nil, big.NewInt(1), "abi: wrong variable size: 0"},
		{"uint0", nil, big.NewInt(1), "abi: wrong variable size: 0"},
		{"fixed0x0", nil, big.NewInt(1), "abi: wrong variable size: 0"},
		{"ufixed0x0", nil, big.NewInt(1), "abi: wrong variable size: 0"},
		{"int1", nil, big.NewInt(1), "abi: wrong variable size: 1"},
		{"uint1", nil, big.NewInt(1), "abi: wrong variable size: 1"},
		{"fixed1x0", nil, big.NewInt(1), "abi: wrong variable size: 1"},
		{"ufixed1x0", nil, big.NewInt(1), "abi: wrong variable size: 1"},
		{"int264", nil, big.NewInt(1), "abi: wrong variable size: 264"},
		{"uint264", nil, big.NewInt(1), "abi: wrong variable size: 264"},
		{"fixed264x0", nil, big.NewInt(1), "abi: wrong variable size: 264"},
		{"ufixed264x0", nil, big.NewInt(1), "abi: wrong variable size: 264"},
		{"bytes33", nil, big.NewInt(1), "abi: wrong variable size: 33"},
		{"ufixed128x01", nil, big.NewInt(1), "abi: wrong fraction digits number: 01"},
		{"fixed256x003", nil, big.NewInt(1), "abi: wrong fraction digits number: 003"},
		{"fixed256x0", nil, big.NewInt(1), "abi: wrong fraction digits number: 0"},
		{"ufixed", nil, big.NewInt(1), "unsupported arg type: ufixed"},
		{"fixed", nil, big.NewInt(1), "unsupported arg type: fixed"},
		{"ufixed128x81", nil, big.NewInt(1), "abi: wrong fraction digits number: 81"},
		{"fixed128x81", nil, big.NewInt(1), "abi: wrong fraction digits number: 81"},
		{"uint256x10", nil, big.NewInt(1), "unsupported type uint256x10: only fixed and ufixed can have number of fraction digits"},
		{"uint256", nil, big.NewInt(1), ""},
		{"ufixed256x80", nil, big.NewInt(1), ""},
		{"int256[111111111111111111111111111111111]", nil, big.NewInt(1), "abi: error parsing array size: strconv.Atoi: parsing \"111111111111111111111111111111111\": value out of range"},
		{"int256[01]", nil, big.NewInt(1), "abi: wrong array size: 01"},
		{"int256[1,2]", nil, big.NewInt(1), "invalid formatting of array type"},
		{"string256", nil, big.NewInt(1), "only int, uint, fixed, ufixed, bytes types can have variable size specified: string256"},
		{"int111111111111111111111111111111111", nil, big.NewInt(1), "abi: error parsing variable size: strconv.Atoi: parsing \"111111111111111111111111111111111\": value out of range"},
		{"fixed256x111111111111111111111111111111111", nil, big.NewInt(1), "abi: error parsing fraction digits number: strconv.Atoi: parsing \"111111111111111111111111111111111\": value out of range"},
		{"fixed256", nil, big.NewInt(1), "abi: fixed type requires fraction digits number to be specified: fixed256"},
		{"ufixed256", nil, big.NewInt(1), "abi: ufixed type requires fraction digits number to be specified: ufixed256"},
		...
		{"fixed256x1", nil, big.NewInt(1), ""},
		{"ufixed8x2", nil, uint8(1), ""},
		{"ufixed16x10", nil, uint16(1), ""},
		{"ufixed32x2", nil, uint32(1), ""},
		{"ufixed64x5", nil, uint64(1), ""},
		{"fixed8x5", nil, int8(1), ""},
		{"fixed16x10", nil, int16(1), ""},
		{"fixed32x9", nil, int32(1), ""},
		{"fixed64x7", nil, int64(1), ""},
		{"ufixed24x10", nil, big.NewInt(1), ""},
		{"ufixed40x30", nil, big.NewInt(1), ""},
		{"ufixed48x40", nil, big.NewInt(1), ""},
		{"ufixed56x50", nil, big.NewInt(1), ""},
		{"ufixed72x70", nil, big.NewInt(1), ""},
		{"ufixed80x5", nil, big.NewInt(1), ""},
		{"ufixed88x6", nil, big.NewInt(1), ""},
		{"ufixed96x7", nil, big.NewInt(1), ""},
		{"ufixed104x8", nil, big.NewInt(1), ""},
		{"ufixed112x9", nil, big.NewInt(1), ""},
		{"ufixed120x10", nil, big.NewInt(1), ""},
		{"ufixed128x11", nil, big.NewInt(1), ""},
		{"ufixed136x12", nil, big.NewInt(1), ""},
		{"ufixed144x13", nil, big.NewInt(1), ""},
		{"ufixed152x14", nil, big.NewInt(1), ""},
		{"ufixed160x15", nil, big.NewInt(1), ""},
		{"ufixed168x16", nil, big.NewInt(1), ""},
		{"ufixed176x17", nil, big.NewInt(1), ""},
		{"ufixed184x18", nil, big.NewInt(1), ""},
		{"ufixed192x19", nil, big.NewInt(1), ""},
		{"ufixed200x20", nil, big.NewInt(1), ""},
		{"ufixed208x21", nil, big.NewInt(1), ""},
		{"ufixed216x22", nil, big.NewInt(1), ""},
		{"ufixed224x23", nil, big.NewInt(1), ""},
		{"ufixed232x24", nil, big.NewInt(1), ""},
		{"ufixed240x25", nil, big.NewInt(1), ""},
		{"ufixed248x26", nil, big.NewInt(1), ""},
		...
		{"fixed24x1", nil, big.NewInt(1), ""},
		{"fixed40x2", nil, big.NewInt(1), ""},
		{"fixed48x3", nil, big.NewInt(1), ""},
		{"fixed56x4", nil, big.NewInt(1), ""},
		{"fixed72x5", nil, big.NewInt(1), ""},
		{"fixed80x6", nil, big.NewInt(1), ""},
		{"fixed88x7", nil, big.NewInt(1), ""},
		{"fixed96x8", nil, big.NewInt(1), ""},
		{"fixed104x9", nil, big.NewInt(1), ""},
		{"fixed112x10", nil, big.NewInt(1), ""},
		{"fixed120x11", nil, big.NewInt(1), ""},
		{"fixed128x12", nil, big.NewInt(1), ""},
		{"fixed136x13", nil, big.NewInt(1), ""},
		{"fixed144x14", nil, big.NewInt(1), ""},
		{"fixed152x15", nil, big.NewInt(1), ""},
		{"fixed160x16", nil, big.NewInt(1), ""},
		{"fixed168x17", nil, big.NewInt(1), ""},
		{"fixed176x18", nil, big.NewInt(1), ""},
		{"fixed184x19", nil, big.NewInt(1), ""},
		{"fixed192x20", nil, big.NewInt(1), ""},
		{"fixed200x21", nil, big.NewInt(1), ""},
		{"fixed208x22", nil, big.NewInt(1), ""},
		{"fixed216x23", nil, big.NewInt(1), ""},
		{"fixed224x24", nil, big.NewInt(1), ""},
		{"fixed232x25", nil, big.NewInt(1), ""},
		{"fixed240x26", nil, big.NewInt(1), ""},
		{"fixed248x27", nil, big.NewInt(1), ""},
		{"uint40", nil, uint8(1), "abi: cannot use uint8 as type ptr as argument"},
		...
		{"ufixed40x1", nil, uint8(1), "abi: cannot use uint8 as type ptr as argument"},
		{"ufixed8x2", nil, uint16(1), "abi: cannot use uint16 as type uint8 as argument"},
		{"ufixed8x3", nil, uint32(1), "abi: cannot use uint32 as type uint8 as argument"},
		{"ufixed8x4", nil, uint64(1), "abi: cannot use uint64 as type uint8 as argument"},
		{"ufixed8x5", nil, int8(1), "abi: cannot use int8 as type uint8 as argument"},
		{"ufixed8x6", nil, int16(1), "abi: cannot use int16 as type uint8 as argument"},
		{"ufixed8x7", nil, int32(1), "abi: cannot use int32 as type uint8 as argument"},
		{"ufixed8x8", nil, int64(1), "abi: cannot use int64 as type uint8 as argument"},
		{"ufixed16x9", nil, uint16(1), ""},
		{"ufixed16x10", nil, uint8(1), "abi: cannot use uint8 as type uint16 as argument"},
		{"ufixed16x10[]", nil, []uint16{1, 2, 3}, ""},
		{"ufixed16x12[]", nil, [3]uint16{1, 2, 3}, ""},
		{"ufixed16x13[]", nil, []uint32{1, 2, 3}, "abi: cannot use []uint32 as type [0]uint16 as argument"},
		{"ufixed16x14[3]", nil, [3]uint32{1, 2, 3}, "abi: cannot use [3]uint32 as type [3]uint16 as argument"},
		{"ufixed16x15[3]", nil, [4]uint16{1, 2, 3}, "abi: cannot use [4]uint16 as type [3]uint16 as argument"},
		{"ufixed16x16[3]", nil, []uint16{1, 2, 3}, ""},
		{"ufixed16x17[3]", nil, []uint16{1, 2, 3, 4}, "abi: cannot use [4]uint16 as type [3]uint16 as argument"},
