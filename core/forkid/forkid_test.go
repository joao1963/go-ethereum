	...
	tests := []struct {
		...
		// Merge test cases
		{
			...
			[]testcase{
				...
				{18000000, 0, ID{Hash: checksumToBytes(0x4fb8a872), Next: 0}},        // First Merge Start block
				{20000000, 0, ID{Hash: checksumToBytes(0x4fb8a872), Next: 0}},        // Future Merge Start block
			},
		},
